    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-xl border-2 border-gray-200 mb-8">
                <div class="p-8">
                    <h3 class="text-2xl font-bold mb-6 text-gray-800">Filter Berdasarkan Rentang Tanggal</h3>
                    <form method="GET" action="{{ route('reports.sales') }}" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label for="start_date" class="block text-xl font-semibold text-gray-700 mb-3">Tanggal Mulai</label>
                            <input type="date"
                                   id="start_date"
                                   name="start_date"
                        ...
                        <div>
                            <label for="end_date" class="block text-xl font-semibold text-gray-700 mb-3">Tanggal Akhir</label>
                            <input type="date"
                                   id="end_date"
                                   name="end_date"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white overflow-hidden shadow-lg rounded-xl border-2 border-gray-200">
                    <div class="p-8">
                        <div class="text-xl font-semibold text-gray-600 mb-3">Total Penjualan</div>
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-xl border-2 border-gray-200">
                    <div class="p-8">
                        <div class="text-xl font-semibold text-gray-600 mb-3">Total Keuntungan</div>
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-xl border-2 border-gray-200">
                    <div class="p-8">
                        <div class="text-xl font-semibold text-gray-600 mb-3">Transaksi</div>
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-xl border-2 border-gray-200">
                    <div class="p-8">
                        <div class="text-xl font-semibold text-gray-600 mb-3">Rata-rata Penjualan</div>
                        <div class="text-5xl font-bold text-orange-600">
                            ${{ $sales->count() > 0 ? number_format($totalSales / $sales->count(), 2) : '0.00' }}
                        </div>
                    </div>
                <div class="p-8">
                    <h3 class="text-2xl font-bold mb-6 text-gray-800">10 Produk Teratas</h3>
                    ...
                    @else
                        <p class="text-xl text-gray-500 py-6">Tidak ada data penjualan produk untuk periode yang dipilih.</p>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-xl border-2 border-gray-200">
                <div class="p-8">
                    <h3 class="text-2xl font-bold mb-6 text-gray-800">Daftar Penjualan Detail</h3>
                    @if($sales->count() > 0)
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y-2 divide-gray-200">
                                <thead class="bg-gray-50">
                    ...
                    @else
                        <p class="text-xl text-gray-500 py-6">Tidak ada catatan penjualan untuk periode yang dipilih.</p>
                    @endif
                </div>
            </div>
        </div>
