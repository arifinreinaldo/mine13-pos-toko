...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris-baris bahasa berikut berisi pesan kesalahan standar yang digunakan
    ...
    */
    ...
    'digits' => ':attribute harus bernilai :digits digit.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Baris-baris Bahasa Validasi Kustom
    |--------------------------------------------------------------------------
    |
    ...
    | baris bahasa kustom tertentu untuk aturan atribut tertentu.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Baris-baris bahasa berikut digunakan untuk menukar tempat pemicu atribut
    | kami dengan sesuatu yang lebih ramah pembaca seperti "Alamat E-Mail"
    | daripada "email". Ini hanya membantu kami membuat pesan lebih ekspresif.
    |
    */
